...
static const NSString * CrashSeparatorWithFlag = @">>>>>>>>>>>>>>>>>>>>>>>> CrashProtector <<<<<<<<<<<<<<<<<<<<<<<<";
@implementation YMYCrashLog
...
+ (void)noteErrorWithException:(NSException *)exception attachedTODO:(NSString *)todo {
    ...
    NSString *logErrorMessage = [NSString stringWithFormat:@"\n\n%@\n\n%@\n%@\n%@\n%@\n%@\n",CrashSeparatorWithFlag, crashType, errorReason, errorPlace, crashProtector, exception.callStackSymbols];
