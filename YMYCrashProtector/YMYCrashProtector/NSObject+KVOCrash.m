...
@implementation KVOProxy{
    ...
    NSMapTable<id, NSMutableSet<CPKVOInfo *> *> *_objectInfosMap; ///< map来维护KVO整个关系
}
...
//    }
    ...
    if (info != nil) {
        ...
        [YMYCrashLog printCrashMsg:[NSString stringWithFormat:@"Cannot remove an observer %@ for the key path '%@' from %@ because it is not registered as an observer.",object,keyPath,self]];
    }
    [self unlock];
}
